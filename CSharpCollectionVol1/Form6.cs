    ...
    public partial class Form6 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            if (save == "Save 1")
            {
                ...
                TextWriter tw = new StreamWriter("notes1.txt");
                tw.WriteLine(notes1);   
                tw.Close();
            }
            else if (save == "Save 2")
            {
                ...
                TextWriter tw = new StreamWriter("notes2.txt");
                tw.WriteLine(notes2);
                tw.Close();
            }
            else if (save == "Save 3")
            {
                ...
                TextWriter tw = new StreamWriter("notes3.txt");
                tw.WriteLine(notes3);
                tw.Close();
            }
            else if (save == "Save 4")
            {
                ...
                TextWriter tw = new StreamWriter("notes4.txt");
                tw.WriteLine(notes4);
                tw.Close();
            }
            else if (save == "Save 5")
            {
                ...
                TextWriter tw = new StreamWriter("notes5.txt");
                tw.WriteLine(notes5);
                tw.Close();
            }
        }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            if (save == "Save 1")
            {
                TextReader tr = new StreamReader("notes1.txt");
            ...
            {
                TextReader tr = new StreamReader("notes2.txt");
                string notes2string = tr.ReadLine();
                notes2 = Convert.ToString(notes2string);
                tr.Close();
                textBox1.Text = notes2string;
            }
            else if (save == "Save 3")
            {
                TextReader tr = new StreamReader("notes3.txt");
                string notes3string = tr.ReadLine();
                notes3 = Convert.ToString(notes3string);
                tr.Close();
                textBox1.Text = notes3string;
            }
            else if (save == "Save 4")
            {
                TextReader tr = new StreamReader("notes4.txt");
                string notes4string = tr.ReadLine();
                notes4 = Convert.ToString(notes4string);
                tr.Close();
                textBox1.Text = notes4string;
            }
            else if (save == "Save 5")
            {
                TextReader tr = new StreamReader("notes5.txt");
